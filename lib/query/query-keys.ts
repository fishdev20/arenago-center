export const queryKeys = {
  ...
  centerPricingRules: () => ["center-pricing-rules"] as const,
  centerPricingSchedule: () => ["center-pricing-schedule"] as const,
  centerPricingOverrides: () => ["center-pricing-overrides"] as const,
